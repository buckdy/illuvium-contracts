...
const { ROLE_TOKEN_CREATOR, ROLE_TOKEN_DESTROYER } = require("../../scripts/include/features_roles");

// Zeppelin unit tests – delivered as behaviours
// basic ERC20 behaviours
const { shouldBehaveLikeERC20 } = require("./include/zeppelin/ERC20.behavior");
...
const { erc20_deploy, NAME, SYMBOL, DECIMALS, S0 } = require("./include/deployment_routines");
