...
const { not, ROLE_ACCESS_MANAGER, ROLE_UPGRADE_MANAGER } = require("../../scripts/include/features_roles");

// import the core ACL behaviour to use
const { behavesLikeACL } = require("./include/acl.behaviour");

// deployment routines in use
const { upgradeable_acl_mock_deploy, upgradeable_acl_mock_deploy_via_proxy } = require("./include/deployment_routines");
