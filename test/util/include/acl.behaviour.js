...
const { not, ROLE_ACCESS_MANAGER } = require("../../../scripts/include/features_roles");
...
function behavesLikeACL(deployment_fn, a0, a1, a2) {
  ...
  describe("ACCESS_MANAGER updates features", function () {
    it("expected features should be enables", async function () {
      await acl.updateFeatures(1, { from: a0 });
      expect(await acl.isFeatureEnabled(1)).to.be.true;
    });
  });
